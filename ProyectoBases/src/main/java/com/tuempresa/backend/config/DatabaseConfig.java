package com.tuempresa.backend.config;
...
/**
 * Responsable exclusivamente de leer y exponer los parámetros de
 * conexión a la base de datos.
 *
 * Los valores se leen de un archivo database.properties ubicado en el
 * classpath (src/main/resources). Mantener las credenciales fuera del
 * código fuente permite cambiarlas sin recompilar y evita subirlas por
 * accidente a un repositorio si el .properties se excluye vía .gitignore.
 *
 * Esta clase es intencionalmente "tonta": no valida reglas de negocio,
